...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={4} footerStyle={1} breadcrumbTitle="construction site">
                <div>
                            ...
                            <div className="col-xl-8">
                                <div className="services-details__content">
                                    <div className="services-details__content-img1">
                                        <img src="assets/img/service/services-details-img6.jpg" alt="#"/>
                                    </div>
                                    ...
                                    <div className="sidebar__single sidebar__category">
                                        ...
                                        <ul className="sidebar__category-list">
                                            ...
                                            <li><Link href="/building-renovation">Building Renovation <span
                                                        className="icon-left-arrow"></span></Link></li>
                                            <li><Link className="active" href="#">Construction Site <span
                                                        className="icon-left-arrow"></span></Link></li>
