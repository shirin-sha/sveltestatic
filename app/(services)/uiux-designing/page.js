...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={4} footerStyle={1} breadcrumbTitle="Ui/Ux Designing">
                <div>
                            ...
                            <div className="col-xl-8">
                                <div className="services-details__content">
                                    <div className="services-details__content-img1">
                                        <img src="assets/img/service/services-details-img4.jpg" alt="#"/>
                                    </div>
                                    ...
                                    <div className="sidebar__single sidebar__category">
                                        ...
                                        <ul className="sidebar__category-list">
                                            ...
                                            <li><Link href="/interior-design">Interior Design <span
                                                        className="icon-left-arrow"></span></Link></li>
                                            <li><Link className="active" href="#">Ui/Ux Designing <span
                                                        className="icon-left-arrow"></span></Link></li>
                                    ...
                                    <div className="sidebar__single sidebar__contact">
                                        <div className="sidebar__contact-inner">
                                            ...
                                            <div className="text-box">
                                                ...
                                                <h4>Free <a href="tel:123456789">+99 (786) 8765</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    {/*End Sidebar Single */}
